...
export const initialAdSettings: AdSettings = {
  ...
  popunderCooldownMinutes: 15,
  popunderCooldownHours: 12,
  welcomePopupEnabled: true,
  mitraInterstitialEnabled: true,
  dualChapterAdsEnabled: true,
...
export const initialAds: AdItem[] = [
  {
    id: 'ad-welcome-popup-default',
    title: 'Pop-Up Selamat Datang Pembaca AntiTimpa',
    type: 'banner',
    position: 'welcome_popup',
    isActive: true,
    imageUrl: 'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=1000&auto=format&fit=crop&q=80',
    targetUrl: 'https://wa.me/6289514441988?text=Halo%20Admin%20AntiTimpa,%20saya%20tertarik%20dengan%20Promo%20VIP%20Uncensored',
    altText: 'Selamat Datang di AntiTimpa - Dapatkan Promo VIP Rp 15rb!',
    badgeLabel: 'HOT PROMO',
    headline: 'Selamat Datang di Portal Komik AntiTimpa!',
    description: 'Nikmati ribuan chapter komik favorit tanpa sensor, update tercepat, dan bebas iklan dengan Paket VIP 15k.',
    ctaText: 'Klaim Promo VIP via WA',
    sponsorName: 'AntiTimpa VIP Network',
    showForVip: false,
    notes: 'Iklan pop-up santai yang muncul 1x per sesi kunjungan awal pembaca dengan tombol silang (X) yang mudah ditutup.',
    createdAt: new Date(Date.now() - 86400000 * 5).toISOString(),
    clickCount: 84,
    viewCount: 1420
  },
  {
    id: 'ad-mitra-interstitial-default',
    title: 'Layar Transisi Mitra (Ganti Animasi Loading)',
    type: 'banner',
    position: 'mitra_interstitial',
    isActive: true,
    imageUrl: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?w=1000&auto=format&fit=crop&q=80',
    targetUrl: 'https://wa.me/6289514441988?text=Halo%20Admin%20AntiTimpa,%20mau%20pasang%20sponsor%20iklan',
    altText: 'Sponsor Mitra Resmi AntiTimpa Portal',
    badgeLabel: 'SPONSOR MITRA',
    headline: 'Sedang Mengarahkan ke Platform Mitra...',
    description: 'Sponsori konten komik dan jangkau ratusan ribu pembaca aktif setiap hari di AntiTimpa.',
    ctaText: 'Pasang Iklan / Hubungi Admin',
    sponsorName: 'Mitra Sponsor Network',
    showForVip: false,
    notes: 'Ditampilkan selama 3-4 detik sebagai pengganti loading polos saat pembaca menuju platform mitra/where-to-read.',
    createdAt: new Date(Date.now() - 86400000 * 4).toISOString(),
    clickCount: 112,
    viewCount: 2350
  },
  {
    id: 'ad-chapter-top-a-default',
    title: 'Banner Atas Chapter - Provider A (Ad Network 1)',
    type: 'banner',
    position: 'chapter_top_a',
    isActive: true,
    imageUrl: 'https://images.unsplash.com/photo-1563089145-599997674d42?w=800&auto=format&fit=crop&q=80',
    targetUrl: 'https://wa.me/6289514441988?text=Halo%20Admin,%20mau%20info%20paket%20VIP',
    altText: 'Provider A: Baca Komik Tanpa Delay',
    badgeLabel: 'ADS #1',
    headline: 'Server Cepat & Tanpa Delay',
    description: 'Akses streaming gambar resolusi tinggi tanpa batas bandwidth.',
    ctaText: 'Lihat Selengkapnya',
    sponsorName: 'Ad Network Alpha',
    showForVip: false,
    notes: 'Slot iklan Provider 1 tepat di atas kolom daftar chapter.',
    createdAt: new Date(Date.now() - 86400000 * 3).toISOString(),
    clickCount: 96,
    viewCount: 3100
  },
  {
    id: 'ad-chapter-top-b-default',
    title: 'Banner Atas Chapter - Provider B (Ad Network 2)',
    type: 'banner',
    position: 'chapter_top_b',
    isActive: true,
    imageUrl: 'https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=800&auto=format&fit=crop&q=80',
    targetUrl: 'https://wa.me/6289514441988?text=Halo%20Admin,%20saya%20mau%20join%20komunitas%20komik',
    altText: 'Provider B: Komunitas Pembaca Komik Terbesar',
    badgeLabel: 'ADS #2',
    headline: 'Gabung Komunitas Discord & WA',
    description: 'Dapatkan notifikasi update chapter tercepat dan giveaway VIP gratis.',
    ctaText: 'Gabung Sekarang',
    sponsorName: 'Ad Network Beta',
    showForVip: false,
    notes: 'Slot iklan Provider 2 berdampingan di atas kolom daftar chapter.',
    createdAt: new Date(Date.now() - 86400000 * 3).toISOString(),
    clickCount: 104,
    viewCount: 3050
  },
  {
    id: 'ad-reader-top-bar-default',
    title: 'Banner Paling Atas Reader (Sebelum Chapter 1)',
    type: 'banner',
    position: 'reader_top_bar',
    isActive: true,
    imageUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1000&auto=format&fit=crop&q=80',
    targetUrl: 'https://wa.me/6289514441988?text=Halo%20Admin,%20mau%20upgrade%20VIP%20Rp15rb',
    altText: 'Bebas Iklan & Dukung Komikus',
    badgeLabel: 'SPONSOR',
    headline: 'Kenyamanan Membaca No. 1',
    description: 'Upgrade ke VIP Rp 15.000 untuk otomatis menyembunyikan semua iklan reader!',
    ctaText: 'Beli VIP 15k',
    sponsorName: 'AntiTimpa VIP',
    showForVip: false,
    notes: 'Tampil rapi di bagian paling atas sebelum gambar komik pertama dimulai.',
    createdAt: new Date(Date.now() - 86400000 * 2).toISOString(),
    clickCount: 158,
    viewCount: 4890
  },
  {
    id: 'ad-reader-bottom-default',
    title: 'Banner Paling Bawah Reader (Setelah Selesai Chapter)',
    type: 'banner',
    position: 'reader_bottom_nav',
    isActive: true,
    imageUrl: 'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=1000&auto=format&fit=crop&q=80',
    targetUrl: 'https://wa.me/6289514441988?text=Halo%20Admin,%20terima%20kasih%20chapternya',
    altText: 'Dukung Kelanjutan Chapter Selanjutnya',
    badgeLabel: 'SPONSOR',
    headline: 'Suka dengan Chapter Ini?',
    description: 'Dukung terus tim translator agar chapter selanjutnya bisa rilis lebih cepat!',
    ctaText: 'Dukung Translator',
    sponsorName: 'Translator Support Hub',
    showForVip: false,
    notes: 'Tampil tepat setelah gambar halaman terakhir selesai dibaca pembaca.',
    createdAt: new Date(Date.now() - 86400000).toISOString(),
    clickCount: 220,
    viewCount: 5120
  },
