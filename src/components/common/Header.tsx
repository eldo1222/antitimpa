          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            ...
            {currentUser ? (
              ...
              <button
                ...
                className="p-2 rounded-xl bg-[#161622] hover:bg-[#1f1f2e] border border-[#252536] hover:border-[#ff5b14]/60 text-slate-300 hover:text-white shadow-sm hover:shadow-md hover:shadow-[#ff5b14]/15 active:scale-95 transition-all cursor-pointer flex items-center justify-center"
              >
                <LogIn className="w-4 h-4 text-[#ff5b14]" />
              </button>
            )}
          </div>
        </div>
                ...
                {currentUser ? (
                  ...
                  <div className="text-center py-2">
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-white hover:bg-slate-100 text-slate-900 text-xs font-bold rounded-xl shadow cursor-pointer transition-all flex items-center justify-center gap-2"
                    >
